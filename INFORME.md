...
![Figura 1. Página de inicio del contenedor](<img width="1187" height="663" alt="inicio" src="https://github.com/user-attachments/assets/0a2a97be-4f3a-4c13-9b61-788852baa6ba" />
 )

### Figura 2. Validación de imagen publicada en Docker Hub

![Figura 2. Imagen publicada en Docker Hub]( <img width="1212" height="742" alt="dockerhub" src="https://github.com/user-attachments/assets/fc0475c5-0574-4749-9e4a-8bea0d934ef2" />
)
